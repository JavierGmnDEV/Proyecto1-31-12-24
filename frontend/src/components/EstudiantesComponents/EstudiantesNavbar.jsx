...
export const EstudiantesNavbar = () => {
  ...
  const menuItems = [
    { to: "/Estudiantes/Plan", label: "Plan de Formación" },
    { to: "/Estudiantes/Notas", label: "Notas" },
    { to: "/Estudiantes/Asistencias", label: "Asistencias" },
    { to: "/Estudiantes/Eventos", label: "Eventos" },
    { to: "/Estudiantes/Estudiantes", label: "Estudiantes" },
